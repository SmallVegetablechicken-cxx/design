...
layui.define(['table', 'form'], function(exports){
    ...
    if(obj.event === 'del'){
      ...
      layer.open({
        ...
        ,yes: function(index, layero){
          ...
          ,submit = layero.find('iframe').contents().find("#layui-app-form-edit");

          //监听提交
          iframeWindow.layui.form.on('submit(layui-app-form-edit)', function(data){
  ...
  table.render({
    ...
    ,cols: [[
      ...
      ,{title: '操作', width: 150, align: 'center', fixed: 'right', toolbar: '#layui-app-cont-tagsbar'}
    ]]
    ,text: '对不起，加载出现异常！'
  });
  ...
  table.on('tool(LAY-app-content-tags)', function(obj){
    ...
    if(obj.event === 'del'){
      ...
      layer.open({
        ...
        ,yes: function(index, layero){
          //获取iframe元素的值
          var othis = layero.find('iframe').contents().find("#layui-app-form-tags")
        ...
        ,success: function(layero, index){
          //给iframe元素赋值
          var othis = layero.find('iframe').contents().find("#layui-app-form-tags").click();
  ...
  table.on('tool(LAY-app-content-comm)', function(obj){
    ...
    if(obj.event === 'del'){
      ...
      layer.open({
        ...
        ,yes: function(index, layero){
          var iframeWindow = window['layui-layer-iframe'+ index]
          ,submitID = 'layui-app-comm-submit'
